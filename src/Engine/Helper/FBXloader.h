...
public:
	...
	void LoadCacheRecursive(FbxNode * pNode, FbxAnimLayer * pAnimLayer);//done

	void UnloadCacheRecursive(FbxNode * pNode); //done

	void LoadCacheRecursive(FbxScene * pScene, FbxAnimLayer * pAnimLayer, const char * pFbxFileName);//done
